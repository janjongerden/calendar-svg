...
import svglib.attributes.HasFill
import svglib.attributes.HasFillImpl
import svglib.attributes.HasOrigin
import svglib.attributes.HasOriginImpl
...
class TEXT(validation: Boolean = false, hasAttributes: HasAttributes = HasAttributesImpl(validation)) :
    ...
    var fontWeight: String? by AttributeProperty()
